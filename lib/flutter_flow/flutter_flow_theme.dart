...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF343434);
  late Color secondaryColor = const Color(0xFF343434);
  late Color tertiaryColor = const Color(0xFFE8191D);
  late Color alternate = const Color(0xFF00A237);
  late Color primaryBackground = const Color(0xFFDDDEDE);
